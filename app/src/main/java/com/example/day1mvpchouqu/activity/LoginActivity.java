...
import com.example.day1mvpchouqu.LoginView;
...
public class LoginActivity extends BaseMvpActivity<AccountModel> implements LoginView.LoginViewCallBack {
    ...
    public void netSuccess(int whichApi, Object[] pD) {
        switch (whichApi) {
            ...
            case ApiConfig.VERIFY_LOGIN:
                ...
                mAppication.setLoginInfo(loginInfo);
                commonPresenter.getData(ApiConfig.GET_HEADER_INFO);
                break;
            case ApiConfig.GET_HEADER_INFO:
                PersonHeader personHeader = ((BaseInfo<PersonHeader>) pD[0]).result;
                mAppication.getLoginInfo().personHeader = personHeader;
                SharedPrefrenceUtils.putObject(this, ConstantKey.LOGIN_INFO, mAppication.getLoginInfo());
                jump();
                break;
        }
    }
    ...
    public void sendVerifyCode(String phoneNum) {
        ...
        commonPresenter.getData(ApiConfig.SEND_VERIFY, phoneNum);
    }
    ...
    public void loginPress(int type, String userName, String pwd) {
        ...
        if (mLoginView.mCurrentLoginType == mLoginView.VERIFY_TYPE)
            commonPresenter.getData(ApiConfig.VERIFY_LOGIN, userName, pwd);
    }
