...
public class DataGroupDateilBottomAdapter extends RecyclerView.Adapter<DataGroupDateilBottomAdapter.ViewHolder> {

    private Context mContext;
    private List<GroupDetailEntity.Thread> mList;

    public DataGroupDateilBottomAdapter(Context pContext, List<GroupDetailEntity.Thread> pList) {
        mContext = pContext;
        mList = pList;
    }
